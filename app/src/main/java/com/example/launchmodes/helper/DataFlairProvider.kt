package com.example.launchmodes.helper
...
class DataFlairProvider : ContentProvider() {
    companion object {
        const val PROVIDER_NAME = "com.example.launchmodes"
        ...
        const val CREATE_DB_TABLE = (" CREATE TABLE " + TABLE_NAME
                ...
                + " name TEXT NOT NULL,empid TEXT NOT NULL,email TEXT NOT NULL,password TEXT NOT NULL);")
